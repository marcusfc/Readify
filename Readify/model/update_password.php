...
//Aqui fem que una vegada executat, vagi al perfil i mostri missatge si s'ha pogut canviar la contrasenya o no
      header('Location: ../view/perfil.php?message=Contraseña actualizada con éxito.');
      exit;
    } else {
      header('Location: ../view/perfil.php?message=Error, no se ha podido cambiar la contraseña');
      exit;
    }
  }
}
